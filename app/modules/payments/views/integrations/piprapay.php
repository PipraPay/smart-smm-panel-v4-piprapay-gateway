            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  <hr>
                  <div class="form-group">
                    <label class="form-label">PipraPay API Key<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][api_key]" value="<?php echo (isset($option->api_key)) ? $option->api_key : ''; ?>">
                  </div>

                  <div class="form-group">
                    <label class="form-label">PipraPay API URL<span class="form-required">*</span></label>
                    <input type="text" class="form-control"  name="payment_params[option][api_url]" value="<?php echo (isset($option->api_url)) ? $option->api_url : ''; ?>">
                  </div>
                  
                  <div class="form-group">
                    <label class="form-label">Currency Code<span class="form-required">*</span></label>
                    <input type="text" class="form-control"  name="payment_params[option][currency]" value="<?php echo (isset($option->currency)) ? $option->currency : ''; ?>">
                  </div>
                </div>
